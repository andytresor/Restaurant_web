...
from Controllers.reservation_controller import index, add_reservation, view_reservation, newReservation, delete_reservation, update_reservation
...
reservation.route('/view/<reservation_id>' , methods=['GET'] , strict_slashes=False)(view_reservation)
